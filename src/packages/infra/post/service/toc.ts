...
export class TocService implements ITocService {
  private static customizeTOC(toc: HtmlElementNode): HtmlElementNode {
  ...
  public async process(html: string, headings?: HeadingTagName[]): Promise<string> {
    ...
    return (await unified()
      ...
      .use(toc, {
        headings: _headings,
        customizeTOC: TocService.customizeTOC,
      })
      .use(stringify)
